...
describe('Test sending message to SQS.', () => {
  const queueUrl = 'https://sqs.us-west-2.amazonaws.com/123456789/queued-builds';
  const message = {
    eventType: 'type',
    id: 0,
    installationId: 0,
...
describe('Test sending message to SQS.', () => {
  ...
  const sqsMessage: SendMessageCommandInput = {
    QueueUrl: 'https://sqs.us-west-2.amazonaws.com/123456789/webhook_events_workflow_job_queue',
